  ...
  const ProductCard = ({
    ...
    if (filteredProducts.length === 0) {
      return (
        <p className="text-center">No products available in this category or matching the ID.</p>
      );
    }
  ...
  ProductCard.propTypes = {
    ...
    productId: PropTypes.oneOfType([PropTypes.string, PropTypes.number]), // إضافة id كخاصية
